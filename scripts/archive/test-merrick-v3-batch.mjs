/**
 * Merrick V3: Cowgirl + Nurse (2 seeds each)
 */
...
const COWGIRL = [
  ...BASE,
  "cowgirl, cowboy hat, tied plaid shirt, crop top, denim short shorts, cowboy boots, belt buckle",
  "gold hoop earrings",
...
const NURSE = [
  ...BASE,
  "nurse outfit, short white nurse dress, nurse cap, red cross, stethoscope, cleavage, bare shoulders",
  "gold hoop earrings",
  "masterpiece, best quality, highres, anime style, visual novel sprite, game cg",
  "cel shading, clean lineart, sharp focus",
].join(", ");
...
async function main() {
  ...
  const jobs = [
    { positive: COWGIRL, prefix: "merrick-v3-cowgirl", label: "Cowgirl" },
    { positive: NURSE, prefix: "merrick-v3-nurse", label: "Nurse" },
  ];
