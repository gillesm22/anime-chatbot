/**
 * Merrick V3: Quick single renders
 */
...
const SCENES = {
  "bayonetta": [...ID, "cowboy shot", "standing, hand on hip, confident smirk, looking over glasses",
    "bayonetta cosplay, tight black bodysuit, skin tight catsuit, glasses, beehive updo with hair accessories, gun holsters on thighs, high heels, cleavage, bare back, seductive",
    "dark background, moonlight, dramatic lighting",
    ...QUALITY].join(", "),

  "bayonetta-v2": [...ID, "cowboy shot", "standing, pose with hand on glasses, smirk",
    "bayonetta cosplay, black skin tight bodysuit, unzipped showing cleavage, butterfly glasses, hair wrapped around body like clothing, gun in hand, long legs, heels",
    "dark city night, dramatic",
    ...QUALITY].join(", "),
};
