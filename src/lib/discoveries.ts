...
export const ALL_INTERACTABLES: Interactable[] = [
  // ── Sakura ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Interesting aerodynamic patterns...", "The scatter radius is approximately—", "...okay that was actually pretty."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Lepidoptera... fascinating wing pattern.", "Don't scare it. I'm observing.", "Its UV reflectance must be remarkable."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Resonant frequency analysis in progress...", "The harmonic overtones are pleasant.", "...I want one for my room."], expression: "thinking" },
  ...
  // ── Beach ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Water temperature: acceptable.", "Hydrodynamic chaos achieved.", "...okay that was refreshing."], expression: "smirk" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Interesting calcium carbonate formation...", "The spiral follows a Fibonacci sequence.", "...I'm keeping this one."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Brachyura detected. Threat level: minimal.", "Its carapace structure is remarkable.", "...don't let it near my cables."], expression: "thinking" },
  ...
  // ── Cafe ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Caffeine: the programmer's elixir.", "Optimal brew temperature: 96°C.", "...third cup. No judgment."], expression: "smirk" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["...it's staring at me. I respect that.", "Felis catus. Independent operator.", "...fine, you can sit on my lap."], expression: "smirk" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["First edition? Interesting.", "The margin notes are encrypted...", "Someone left a cipher in chapter 3."], expression: "excited" },
  ...
  // ── Cyberpunk ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Gas discharge illumination. My domain.", "The flicker frequency is intentional.", "...I designed one of these once."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Original hardware. Respect.", "The input lag is 4ms. Acceptable.", "I've reverse-engineered this ROM before."], expression: "excited" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Autonomous unit. Who built this?!", "The servo motors are custom... incredible.", "I need to open it up. FOR SCIENCE."], expression: "excited" },
  ...
  // ── Rain ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Electrostatic discharge. Beautiful.", "Calculating distance by delay...", "3.2 kilometers. Getting closer."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Amphibian surveillance unit detected.", "Rain-responsive biomonitor. Noted.", "...he's just sitting there. Power move."], expression: "smirk" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Abandoned equipment. Mine now.", "The mechanism is jammed. I can fix it.", "...sharing an umbrella? That's... whatever."], expression: "shy" },
  ...
  // ── Night Sky ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Meteoroid entry velocity: impressive.", "Actually a grain of cosmic dust burning up.", "...I wished anyway. Don't tell anyone."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["8-inch reflector. Decent optics.", "I can see the Orion Nebula from here.", "...this is mine now."], expression: "excited" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["FINALLY. I've been tracking anomalies for weeks!", "Signal frequency matches my predictions!", "This changes EVERYTHING."], expression: "excited" },
  ...
  // ── Cozy Room ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Combustion temperature: optimal.", "The infrared radiation is... pleasant.", "...fine, this is nice."], expression: "happy" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Synthetic plush construct. Sentimental value: high.", "The wear patterns suggest years of use.", "...I had one once. Classified information."], expression: "shy" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Analog photography. No metadata. Secure.", "The composition is... surprisingly artistic.", "Memories stored without cloud access. Admirable."], expression: "thinking" },
  ...
  // ── Moonlight ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Lunar phase progression: fascinating.", "Reflected sunlight at 0.12 albedo.", "...it IS prettier than my calculations suggest."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Strigiformes. Excellent nocturnal predator.", "Asymmetric ear placement for echolocation.", "...we have an understanding."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Bioluminescent reaction? No... just moonlight.", "Rosa damascena. Surprisingly complex genome.", "...the scent is... fine. Whatever."], expression: "shy" },
  ...
  // ── Lab ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Exothermic reaction in progress.", "The catalyst ratio needs adjustment.", "...don't touch that. I'm serious."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Encrypted data stream. Challenge accepted.", "The refresh rate is non-standard... interesting.", "Someone doesn't want this found."], expression: "excited" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Resonant transformer. 500kV potential.", "The arc frequency is tunable...", "I could power my entire setup with this."], expression: "excited" },
  ...
  // ── Morning ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Passerine. Dawn chorus participant.", "Frequency: 2-4 kHz. Pleasant.", "...morning routines are important."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Heliotropism. Solar tracking behavior.", "The Fibonacci spiral in the seeds...", "Nature's algorithm. Elegant."], expression: "thinking" },
  ...
  // ── Sunset ──
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Acoustic guitar. Open tuning. Skill level: high.", "The reverb from the buildings creates natural delay.", "...Shazam can't find it. Original composition."], expression: "thinking" },
  ...
  },
  {
    ...
    reactions: {
      ...
      suzuka: { lines: ["Pyrotechnic charge detected. IGNITE.", "Strontium chloride for red, barium for green...", "...okay. THAT was impressive."], expression: "excited" },
