# Project note (migrated from Upside session memory, 2026-07-22)

This note was originally stored in the Upside project's Claude memory. It has
been moved here so nothing anime-chatbot-related lives under the Upside folder.
The repo's own `CLAUDE.md` remains the source of truth for architecture,
